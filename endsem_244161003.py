# -*- coding: utf-8 -*-
"""EndSem_244161003.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_paJ5-w0Krj4kfCrdXvVVv3e8fx_eoUm

# **Bishal Sarkar  Roll-244161003**
# **FINAL PROJECT**
...
df = pd.read_csv("/content/drive/MyDrive/Project Dataset/ML Project/Health_Insurance_Premium_Charges_Prediction_11.csv")
print(df.head())
...
for name, model in models.items():
    ...
    if name == 'Decision Tree':
        ...
        feature_names = numeric_cols + [
            f"{col}_{value}" for col, values in zip(categorical_cols, categories) for value in values
        ]

        dot_data = export_graphviz(pipeline.named_steps['model'], out_file=None,
    ...
    if name in ['Linear Regression', 'Ridge Regression', 'Random Forest']:
        ...
        fig = px.scatter(results_df, x=y_test.name, y='Predicted',
                         title=f"{name} - Actual vs Predicted Charges",
